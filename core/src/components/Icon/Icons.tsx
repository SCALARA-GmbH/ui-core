...
export const icons: Record<IconName, Svg> = {
  ...
  attention: {
    children: (
      <>
        <path
          className="cls-1"
          d="M12.9,2.81H11.1L3,19.56,3.85,21h16.3l.9-1.44ZM5.45,19,12,5.54,18.55,19Z"
        />
        <circle cx="12" cy="16.63" r="1.25" />
        <rect x="11" y="9.63" width="2" height="5" />
      </>
    ),
    viewBox: viewBox24,
    size: 24,
  ...
  'piggy-bank': {
    children: (
      <>
        <rect x="30" y="18" width="2" height="3" />
        <path d="M36.62,17a11.63,11.63,0,0,0-4.35-4.49l2-4.93-.74-.44a5.14,5.14,0,0,0-6.22,1.15l-2.61,3.47-.21-.09a7,7,0,1,0-12.59.69,15.22,15.22,0,0,0-5,5.41c-.18.31-.32.63-.47.95a4.11,4.11,0,0,1-1.93-1.63,3.81,3.81,0,0,0,1.06-.16,3.41,3.41,0,0,0,2.18-1.67,2.83,2.83,0,0,0-.12-2.71,2.8,2.8,0,0,0-2.45-1.14A2.73,2.73,0,0,0,2.46,13.7,6.73,6.73,0,0,1,2,11H0c0,2.52.68,4.31,2,5.31l.17.12A5.53,5.53,0,0,0,5.72,20.6a9.61,9.61,0,0,0,1.54,8.17A8.93,8.93,0,0,0,11,31.69V38h5.62l2-4h4.76l2,4h4.44l1.1-5.51L36.41,27H40V17ZM5.15,13.41c.39,0,.68.09.78.25a1,1,0,0,1-.06.84A1.84,1.84,0,0,1,5,15a2,2,0,0,1-.76.06C4.31,14.29,4.55,13.41,5.15,13.41ZM13,9A5,5,0,0,1,23,9a5.17,5.17,0,0,1-.44,2.05,13.9,13.9,0,0,0-8.91.39A5,5,0,0,1,13,9ZM38,25H35.59l-6.51,6.51L28.18,36H26.62l-2-4H17.38l-2,4H13V30.28l-.68-.23a6.94,6.94,0,0,1-3.46-2.48,7.94,7.94,0,0,1-.25-8.79c5.88-10.11,15.51-5.11,15.92-4.9l.76.41,3.47-4.63a3.29,3.29,0,0,1,2.93-1.07l-2,4.95.9.38a9.57,9.57,0,0,1,4.47,4.47l.26.61H38Z" />
      </>
    ),
    viewBox: viewBox40,
    size: 40,
