...
describe('<Card />', () => {
  it('renders without crashing', () => {
    const { container } = render(<Card label={'Action'} onClick={jest.fn} img={''} text={'Text'} title={'Title'} />);
    expect(container).toBeInTheDocument();
  });
  it('renders without warning', () => {
    console.warn = jest.fn();
    render(<Card label={'Action'} onClick={jest.fn} img={''} text={'Text'} title={'Title'} />);
  ...
  it('renders inner components', () => {
    const { getByText, queryByTestId } = render(
      <Card testId={'cardId'} label={'Action'} onClick={jest.fn} img={''} text={'Text'} title={'Title'} />,
    );
  ...
  it('fires onClick when clicked', () => {
    ...
    const { getByTestId } = render(
      <Card testId={'cardId'} label={'Action'} onClick={handleClick} img={''} text={'Text'} title={'Title'} />,
    );
